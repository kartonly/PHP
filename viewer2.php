...
<input style="border-radius: 10px; border:0px;" type="submit" name="del" id="del" class="form-control" value="Удалить">
...
if( isset($_POST['buttonupdate']) && $_POST['buttonupdate']== 'Опубликовать'){
  ...
  $mysqli = mysqli_connect('std-mysql', 'std_941', '84996111636', 'std_941');
$sql_res=mysqli_query($mysqli,'UPDATE std_941.form SET qu1="'.$nameup.'", qu2="'.$surnameup.'", qu3="'.$documentup.'" WHERE ids='.$numup.'');
$nameup = '';
$surnameup = '';
$documentup = '';
header("Refresh: 0");
